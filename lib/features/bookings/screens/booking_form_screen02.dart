...
class BookingFormScreen02 extends StatefulWidget {
  Provider? provider;
  Lounge? lounge;

  BookingFormScreen02({super.key, this.provider, this.lounge});

  @override
  State<BookingFormScreen02> createState() => _BookingFormScreen02State();
}

class _BookingFormScreen02State extends State<BookingFormScreen02> {
  ...
  Widget build(BuildContext context) {
    LogService.screenLoad('BookingFormScreen');
    return Scaffold(
                ...
                child: _GlassBox(
                  child: Row(
                    children: [
                      CircleAvatar(
                        radius: 30,
                        backgroundImage: NetworkImage(widget.lounge!.imageUrl),
                      ),
                      const SizedBox(width: 16),
                      Expanded(
                        child: Column(
                ...
                onPressed: _isSubmitting
                    ...
                    : () async {
                        ...
                        try {
                          ...
                          final timeOfDay = timeFormat.parse(selectedTime);
                          ...
                          LogService.info('Submitting booking to Strapi API', {
                            'target': name,
                          ...
                          await BookingService().createBookingV2(
                            ...
                            totalAmount: pricePerHour * selectedDuration,
                          );
